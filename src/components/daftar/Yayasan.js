    ...
    render() {
        return(
            <div>
                ...
                <InputFile name="surat_izin_operasional" id="surat_izin_operasional" type="file" label="Surat Izin Operasional" buttonLabel="Surat Izin Operational" section="documents" required={ false } typeOA={ this.props.propsData.form.type } placeholder="" validation={ [
                    {
                        typeValidate: 'file',
                        maxSize: 5000000,
                        fileType: ['image/jpeg', 'image/jpg', 'image/png', 'application/pdf']
                ...
                <InputFile name="tanda_daftar" id="tanda_daftar" type="file" label="Tanda Daftar" buttonLabel="TDY" section="documents" required={ false } typeOA={ this.props.propsData.form.type } placeholder="" validation={ [
                    {
                        typeValidate: 'file',
                        maxSize: 5000000,
                        fileType: ['image/jpeg', 'image/jpg', 'image/png', 'application/pdf']
