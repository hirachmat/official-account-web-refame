    ...
    render() {
        return(
            <div>
                ...
                <div className="uk-margin" id="field-documents-surat_izin_operasional">
                    <label className="uk-form-label form__label-item" htmlFor="surat_izin_operasional">Surat Izin Operasional Yayasan</label>
                    <label className="uk-form-label form__label-item-small">(ukuran maksimal: 5Mb)</label>
                    <div uk-form-custom="true">
                        <input type="file" title="Surat Izin Usaha Perdagangan (SIUP)" 
                        id="field-surat-izin-usaha-perdagangaan-perusahaan" name="surat_izin_operasional"
                        onChange={ 
                            (e) => this.handleInput(e, "surat_izin_operasional", [
                                {
                                    typeValidate: 'file',
                                    maxSize: 5000000,
                                    fileType: ['image/jpeg', 'image/jpg', 'image/png', 'application/pdf']
                    ...
                    <div className="uk-margin-small">
                        { this.props.propsData.formErrors.section.documents.surat_izin_operasional === "" && (
                            <label className="uk-form-label form__label-item-small" onClick={ (e) => this.handleShowPreview(this.props.propsData.nameFile.surat_izin_operasional) }>{ this.props.propsData.nameFile.surat_izin_operasional }</label>
                        ) }
                        { this.renderErrorMessage(this.props.propsData.formErrors.section.documents.surat_izin_operasional, 'surat izin operasional', "") }
                    </div>
                </div>
                <div className="uk-margin" id="field-documents-tanda_daftar">
                    <label className="uk-form-label form__label-item" htmlFor="tanda_daftar">Tanda Daftar { this.props.propsData.form.type } (TDY)</label>
                    <label className="uk-form-label form__label-item-small">(ukuran maksimal: 5Mb)</label>
                    <div uk-form-custom="true">
                        <input type="file" title="Surat Izin Usaha Perdagangan (SIUP)" 
                        ...
                        <button className="uk-button form__button-upload" type="button" tabIndex="-1">Upload Foto TDY</button>
                    </div>
                    <div className="uk-margin-small">
